...
//		var lat = 37.38;
	...
	function init() {
		...
		$('re-login').addEventListener('click', reLogin);

		hideElement($('re-login'));
		hideElement($('extra-info'));
...
//		 });
	...
	function signUp() {
		...
		console.log("success");
		showElement($('re-login'));
		showElement($('extra-info'));
	}
	...
	function showSignError() {
		$('login-error').innerHTML = 'Username Already Existed';
	}
